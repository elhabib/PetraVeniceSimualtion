...
public class ExecTravelTimeBetweenPoIs {
	...
	public static void main(String[] args) throws Exception {
		...
		sim.loadHistory("./output/simulationHistoryNonCrowdedWeekend.csv");
		System.out.println("** Simulation History Loaded **");
		
		/* Saving PoIs Travel times */
		System.out.println("** Saving Travel Times between PoIs **");
		tploc.saveTravelTimeHistory("./output/PoIsTravelTimesNonCrowdedWeekend.csv", paths);
		System.out.println("** Travel Times between PoIs Saved **");
	}
